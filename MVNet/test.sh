...
#python main.py --eval-mode --split-mode test --backbone deeplab50 --weights save/training_base_deeplab/model_base.pth --stm-queue-size 3 --sample-rate 3 --savedir save/eval_base_deeplab --baseline-mode
